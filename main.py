...
pygame.display.set_caption("Adventure - The Game")
BG_COLOR = (0, 0, 0)
...
# Função para carregar o bloco
def get_block(size, tipo="terreno_vermelho"):
...
class Player(pygame.sprite.Sprite):
    COLOR = (255, 0, 0) #Cor do jogador
    GRAVITY = 1
    SPRITES = load_sprite_sheets("MainCharacters", "VirtualGuy", 32, 32, True)
    ANIMATION_DELAY = 3 #Delay da animação
...
def main(window):
    ...
    background, bg_image = get_background("bgmain1.png")

    block_size = 96

    player = Player(100, 100, 75, 75)
    fire = Fire(830, HEIGHT - block_size - 64, 16, 32)
    fire.on()
